...
public:
    ...
    bool __fastcall EnumResources(String dir, String FileName);
    ...
    void __fastcall AddDfm(TDfm* );
    void __fastcall AddAlias(String );
    bool __fastcall HasAlias(String name) const;
    int __fastcall GetAliasCount() const {return Aliases->Count;}
    String __fastcall GetAlias(int idx);
    void __fastcall SetAliasValue(String key, String val);
    int __fastcall AnalyzeSection(TDfm* Dfm, TStringList* FormText, int From, PComponentInfo CInfo, int objAlign);
    TDfm* __fastcall GetDfm(int idx) const;
    int __fastcall GetDfmCount() const {return FormList->Count;}
    HINSTANCE GethFormPlugin() const {return hFormPlugin;}

    void __fastcall FreeFormPlugin();
    bool __fastcall GetIsCitadel() const {return citadel;}
    void __fastcall SetIsCitadel(bool b) {citadel = b;}
    void __fastcall SetFormPluginName(String n) {FormPluginName = n;}
