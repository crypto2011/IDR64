...
{
public:
    __fastcall TIDCGen(String idcName);
    __fastcall ~TIDCGen();

    void __fastcall Generate(String idcTemplate, DWORD _CodeBase, DWORD _TotalSize);
...
private:
    ...
    void __fastcall MakeComm(int pos, String text);
    
    int  __fastcall OutputAttrData(int pos);
    void __fastcall OutputHeaderFull(DWORD _CodeBase);
