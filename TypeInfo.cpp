...
String __fastcall TFTypeInfo_11011981::GetRTTI(DWORD adr)
{
    ...
    DWORD       propType, methAdr, procSig;
    ULONGLONG   getProc, setProc, storedProc;
    BYTE        GUID[16];
    ...
    case ikEnumeration:
        ...
        //BaseTypeAdr
        typeAdr = *((ULONGLONG*)(Code + pos)); pos += 8;
    ...
    case ikSet:
        result = "set of ";
        pos++;  //skip ordType
        typeAdr = *((ULONGLONG*)(Code + pos));
        result = "set of " + GetTypeName(typeAdr);
        break;
    case ikClass:
        result = "class";
        classVMT = *((DWORD*)(Code + pos)); pos += 8;
        parentAdr = *((DWORD*)(Code + pos)); pos += 8;
        ...
        {
            propType = *((ULONGLONG*)(Code + pos)); pos += 8;
            posn = Adr2Pos(propType); posn += 8;
            posn++; //property type
            len = Code[posn]; posn++;
            typname = String((char*)(Code + posn), len);
            getProc = *((ULONGLONG*)(Code + pos)); pos += 8;
            setProc = *((ULONGLONG*)(Code + pos)); pos += 8;
            storedProc = *((ULONGLONG*)(Code + pos)); pos += 8;
            //idx
            pos += 4;
            //defval
            pos += 4;
            ...
            if ((getProc & 0xFFFFFF0000000000))
            {
                ...
                if ((getProc & 0xFF00000000000000) == 0xFF00000000000000)
                    result += name + " f" + Val2Str0(getProc & 0x0FFFFFF);
            ...
            if ((setProc & 0xFFFFFF0000000000))
            {
                ...
                if ((setProc & 0xFF00000000000000) == 0xFF00000000000000)
                    result += name + " f" + Val2Str0(setProc & 0x0FFFFFF);
            ...
            if ((storedProc & 0xFFFFFF0000000000))
            {
                ...
                if ((storedProc & 0xFF00000000000000) == 0xFF00000000000000)
                    result += name + " f" + Val2Str0(storedProc & 0x0FFFFFF);
        ...
        for (i = 0; i < propCount; i++)
        {
            ...
            if (idr.IsFlagSet(cfImport, Adr2Pos(propType)))
            {
    ...
    case ikMethod:
        ...
        pos += 8 * paramCount;
        //MethSig
        procSig = *((ULONGLONG*)(Code + pos)); pos += 8;
        //AttrData
        dw = *((WORD*)(Code + pos));
        pos += dw;//ATR!!
        //Procedure Signature
        if (procSig)
        {
            ...
            if (flags != 0xFF)
            {
                ...
                //ResultType
                resultTypeAdr = *((ULONGLONG*)(Code + posn)); posn += 8;
                //ParamCount
                ...
                for (i = 0; i < paramCount; i++)
                {
                    ...
                    if (paramFlags & PfVar)
                        ...
                        proto += "array ";
                    typeAdr = *((ULONGLONG*)(Code + posn)); posn += 8;
                    len = Code[posn]; posn++;
    ...
    case ikArray:
        ...
        resultTypeAdr = *((ULONGLONG*)(Code + pos)); pos += 8;
        result = "array [";
        //DimCount
    ...
    case ikRecord:
        ...
        if (elNum)
        {
            ...
            {
                typeAdr = *((ULONGLONG*)(Code + pos)); pos += 8;
                elOff = *((ULONGLONG*)(Code + pos)); pos += 8;
        ...
        for (m = 0; m < methCnt; m++)
        {
            ...
            pos++;
            //Code
            methAdr = *((ULONGLONG*)(Code + pos)); pos += 8;
            //Name
            len = Code[pos]; pos++;
            name = String((char*)(Code + pos), len); pos += len;
            result += "\n" + name;
    ...
    case ikInterface:
        ...
        break;
    case ikInt64:
        minInt64Value = *((LONGLONG*)(Code + pos)); pos += 8;
        maxInt64Value = *((LONGLONG*)(Code + pos));
    ...
    case ikDynArray:
        ...
        //elType
        elType = *((ULONGLONG*)(Code + pos)); pos += 8;
        result = "array of " + GetTypeName(elType);
        //varType
        varType = *((ULONGLONG*)(Code + pos)); pos += 8;
        //elType2
        pos += 8;
        //UnitName
        len = Code[pos]; pos++;
